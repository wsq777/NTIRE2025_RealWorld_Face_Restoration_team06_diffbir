...
from models.team06_diffbir.run import run as run_infer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_dir", default="/root/autodl-tmp/data/face/test", type=str, help="Path to the test set")
